...
Mainly used to adjust the basePath when the website is served on a subdomain (i.e. [ucsdanimeclub.github.io/club-next-site/](https://ucsdanimeclub.github.io/club-next-site/)) instead
of [ucsd.moe](https://ucsd.moe).
